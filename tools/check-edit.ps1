...
$cases = @(
    ...
    # x=700 and y=100, both deliberate. The tab strip sits above the editor
    # field and the gutter runs down its left edge, so a click near the top of
    # the window switches documents and a click near its left sets a
    # breakpoint. Neither is what this check is about.
    ...
    @{n='click-collapses'; f='a'; c='move all;;click 700 100;;sel'; w='no selection'}
